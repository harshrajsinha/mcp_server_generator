...
<body>
    ...
    <p><strong>Database Tools:</strong> {len(self.mcp_server.tool_registry._tools)} available</p>
...
@click.option("--config-path", help="Path to database configuration file")
...
def main(host: str, port: int, config_path: str, db_path: str, create_admin: str, debug: bool) -> int:
    """
