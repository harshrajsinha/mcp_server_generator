...
if __name__ == '__main__':
    ...
    print("   - Home: http://localhost:30211")
    print("   - Health Check: http://localhost:30211/health")
    print("   - About: http://localhost:30211/about")
    print("\nAPI Endpoints:")
    ...
    print("\n" + "="*70)
    print("[READY] Server starting on port 30211")
    print("="*70 + "\n")
